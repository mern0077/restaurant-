...
const Restaurant = () => {
  ...
  useEffect(() => {
    ...
    fetchRestaurant();
    console.log("from here",restaurant);
...
//     const { createRestaurant, updateRestaurant, restaurant, loading } = useRestaurantStore();
...
//                                         value={input.restaurantName} onChange={ChangeEventHandler} placeholder="Enter your restaurant name" />
//                                     {errors && <span className="text-xs text-red-600 font-medium" >{errors.restaurantName}</span>}
//                                 </div>
//                                 <div>
//                                     <Label>City</Label>
//                                     <Input type="text" name="city" value={input.city} onChange={ChangeEventHandler} placeholder="Enter your city name" />
//                                     {errors && <span className="text-xs text-red-600 font-medium" >{errors.city}</span>}
//                                 </div>
//                                 <div>
//                                     <Label>Country</Label>
//                                     <Input type="text" name="country" value={input.country} onChange={ChangeEventHandler} placeholder="Enter your country name" />
//                                     {errors && <span className="text-xs text-red-600 font-medium" >{errors.country}</span>}
//                                 </div>
//                                 <div>
//                                     <Label>Delivary Time</Label>
//                                     <Input type="number" name="deliveryTime" value={input.deliveryTime} onChange={ChangeEventHandler} placeholder="Enter your delivary time" />
...
//                             <div className="my-5 w-fit">
//                                 {
//                                     loading ? (<Button disabled className="w-full bg-orange hover:bg-hoverOrange"><Loader2 className="mr-2 h-4 w-4 animate-spin" />Please Wait</Button>) : (<Button className="bg-orange hover:bg-hoverOrange" >{restaurant ? "Update Your restaurant" : "Add Your Restaurant"}</Button>)
//                                 }
//                             </div>
//                         </form>
//                     </div>
