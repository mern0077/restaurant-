            ...
            <div className='flex items-center justify-center min-h-screen w-full'>
                <form className='flex flex-col gap-5 md:border md:p-8 w-full max-w-md rounded-lg mx-4'>
                    <div className='text-center'>
                        ...
                        <p className='text-sm text-gray-600'>Enter your new password for login</p>
                    </div>
                    <div className="relative">
                        <Input type="email" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="Enter your new password" className="pl-10" />
